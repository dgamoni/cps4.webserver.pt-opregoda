...
function thb_bgecho($array, $setting = false) {
	if(!empty($array)) {
		if (!empty($array['background-color']) || $setting = 'background-color') { 
			echo "background-color: " . $array['background-color'] . " !important;\n";
		}
		if (!empty($array['background-image']) || $setting = 'background-image') { 
		...
		if (!empty($array['background-repeat']) || $setting = 'background-repeat') { 
			echo "background-repeat: " . $array['background-repeat'] . " !important;\n";
		}
		if (!empty($array['background-attachment']) || $setting = 'background-attachment') { 
			echo "background-attachment: " . $array['background-attachment'] . " !important;\n";
		}
		if (!empty($array['background-position']) || $setting = 'background-position') { 
			echo "background-position: " . $array['background-position'] . " !important;\n";
		}
		if (!empty($array['background-size']) || $setting = 'background-size') { 
