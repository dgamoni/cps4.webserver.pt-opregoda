<?php 
	...
	// WP Remote Get Check
	$posting['wp_remote_get']['name'] = esc_html__( 'Remote Get', 'twofold');
...
<table class="widefat" cellspacing="0">
	<thead>
		<thead>
			<tr>
				<td><?php esc_html_e( 'Requirements', 'twofold' ); ?></td>
				<td></td>
			</tr>
		</thead>
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			<tr>
				<td data-export-label="Server Memory Limit">
					<?php esc_html_e( 'Server Memory Limit', 'twofold' ); ?>:
				</td>
				<td>
					<?php
					...
					<?php else: ?>
						<mark class="<?php echo esc_attr($mark); ?>">
								...
								<?php esc_html_e('The recommended value is 256M.', 'twofold'); ?>
						</mark>
					<?php endif; ?>
			...
			<tr>
				<td data-export-label="PHP Version"><?php esc_html_e( 'PHP Version:', 'twofold' ); ?></td>
				<td>
					<?php 
					...
					?>
						...
						<?php else: ?>
							<mark class="<?php echo esc_attr($mark); ?>">
									...
									<?php esc_html_e('Required PHP Version is at least 5.6. WordPress <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using at least PHP 7.0.</a> ', 'twofold'); ?>
							</mark>
						<?php endif; ?>
					<?php	} ?>
				</td>
			...
			<tr>
				<td data-export-label="PHP Time Limit"><?php esc_html_e( 'PHP Time Limit', 'twofold' ); ?>:</td>
				<td>
					<?php
					...
					<?php else: ?>
						<mark class="<?php echo esc_attr($mark); ?>">
								...
								<?php esc_html_e('The recommended value is 30.', 'twofold'); ?>
						</mark>
					<?php endif; ?>
		...
		<?php endif; ?>
		<tr>
			<td data-export-label="Max Upload Size"><?php esc_html_e( 'Max Upload Size', 'twofold' ); ?>:</td>
			<td>
				<?php
				...
				<?php else: ?>
					<mark class="<?php echo esc_attr($mark); ?>">
							...
							<?php esc_html_e('The recommended value is 12M.' , 'twofold'); ?>
					</mark>
				<?php endif; ?>
			</td>
		</tr>
		<?php
			...
			$posting['fsockopen_curl']['help'] = '<a href="#" class="help_tip" data-tip="' . esc_attr__( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'twofold' ) . '">[?]</a>';
